        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="font-poppins text-sm text-gray-300 leading-relaxed">
              {INSTITUTION.yearsOfExperience}+ anos de dedicação à educação infantil com excelência, amor e cuidado.
            </p>
          </div>

          {/* Localização */}
          <div>
            <h3 className="font-fredoka-one text-lg mb-4 text-red-400">Localização</h3>
            <a
              href="#"
              className="font-poppins text-sm text-gray-300 hover:text-red-400 transition-colors flex items-start gap-2 group"
            >
              <MapPin size={18} className="mt-0.5 flex-shrink-0 group-hover:scale-110 transition-transform" />
          ...
          {/* Contato */}
          <div>
            <h3 className="font-fredoka-one text-lg mb-4 text-orange-400">Contato</h3>
          ...
          {/* Links Rápidos */}
          <div>
            <h3 className="font-fredoka-one text-lg mb-4 text-yellow-400">Links Rápidos</h3>
            <ul className="space-y-2">
              <li>
                <a href="/" className="font-poppins text-sm text-gray-300 hover:text-yellow-400 transition-colors flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-yellow-400 group-hover:scale-150 transition-transform"></span>
                  Home
                </a>
              </li>
              <li>
                <a href="/#about" className="font-poppins text-sm text-gray-300 hover:text-yellow-400 transition-colors flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-yellow-400 group-hover:scale-150 transition-transform"></span>
                  A Entidade
                </a>
              </li>
              <li>
                <a href="/transparencia" className="font-poppins text-sm text-gray-300 hover:text-yellow-400 transition-colors flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-yellow-400 group-hover:scale-150 transition-transform"></span>
                  Transparência
                </a>
              </li>
              <li>
                <a href="/estrutura" className="font-poppins text-sm text-gray-300 hover:text-yellow-400 transition-colors flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-yellow-400 group-hover:scale-150 transition-transform"></span>
                  Estrutura
                </a>
              </li>
          ...
          {/* Redes Sociais */}
          <div>
            <h3 className="font-fredoka-one text-lg mb-4 text-teal-400">Siga-nos</h3>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="font-poppins text-sm text-gray-400 text-center md:text-left">
              © {new Date().getFullYear()} {INSTITUTION.shortName}. Todos os direitos reservados.
            </p>
